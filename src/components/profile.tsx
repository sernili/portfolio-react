        ...
        <div className="grid items-center gap-12 md:grid-cols-[1fr_1.5fr]">
          ...
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              <p>
                I focus on <strong>frontend and web development</strong> with technologies
                like&nbsp;
                <strong>HTML, CSS, JavaScript, Tailwind, React, and TypeScript</strong>, while
                staying open to learning and applying new tools. My main strength lies in building
                clean, responsive user interfaces, with an outlook to grow further towards&nbsp;
            ...
            <div className="space-y-6">
              ...
              <p>
                ...
                designs are user-friendly and align with brand identity. My goal is to connect
                design and development, making ideas tangible and ready for implementation.
              </p>
            </div>
